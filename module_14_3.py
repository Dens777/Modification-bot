...
pr_button1=InlineKeyboardButton(text='Продукт1', callback_data='product_buying')
pr_button2=InlineKeyboardButton(text='Продукт2', callback_data='product_buying')
pr_button3=InlineKeyboardButton(text='Продукт3', callback_data='product_buying')
pr_button4=InlineKeyboardButton(text='Продукт4', callback_data='product_buying')
...
async def get_info(message):
    with open('images/Logo.jpg', "rb") as img:
        await message.answer_photo(img,
                               'Онлайн-магазин по продаже витаминных комплексов '
                               'и биологически активных добавок www.superbad.ru'
                               )
